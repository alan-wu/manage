stage 'build' 
	node {
		...
		dir('build') {
			...
			sh '/home/alan/Downloads/cmake-3.4.3-Linux-x86_64/bin/cmake -DBUILD_TESTS=OFF -DMPI=openmpi -DMPI_HOME="" -DSYSTEM_MPI=NO -DEVIL=YES -DOC_PYTHON_BINDINGS_USE_VIRTUALENV=NO'
			sh 'make'
			echo 'Built'
